    ...
    "    uniform         mat4   dotsMatrix;                                                                                  \n"     
    "    varying  highp  vec4   dotsCoords;                                                                                       \n"               
    //--------------------------------------------                                        
    ...
    "     dotsCoords              =  dotsMatrix * position;                                                                             \n"         
          //===============================================================================
    ...
    "    uniform  sampler2D     Dots_TEXTURE;                                                                                     \n"       
    "    varying  highp  vec4   dotsCoords;                                                                                       \n"    
    //--------------------------------------------
    ...
    "    shadowVal                =  comp <= depth_PowerVR ? 1.0 : 0.5;                                                             \n" 
         //--------------------------------------------------------------------------------------------- 
...
*/   
     ...
     "    gl_FragColor             =  texture2D(Dots_TEXTURE, dotsCoords.xy*100.0) ;                                                                                            \n" 
   ...
   // "    gl_FragColor.w           =   shadowVal;                                                                                    \n"     
    ...
    //=======================================================================================================================                   
        ...
        UNIFORM_DOTS_MATRIX_baseRoom                        = glGetUniformLocation(baseRoom_SHADER, "dotsMatrix");          
        ...
        UNIFORM_DOTS_TEXTURE                                = glGetUniformLocation(baseRoom_SHADER, "Dots_TEXTURE");           
