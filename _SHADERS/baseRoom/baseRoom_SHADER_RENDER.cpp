  ...
  //MultiplyMatrix(ShadowLight_TextureMatrix, ShadowLight_TextureMatrix, invertView);    //MULTIPLY THESE TO A TEMP MATRIX TO AVOID ROUND OFF ERRORS
    ...
    LoadIdentity(dotsMatrix);
    //MultiplyMatrix(dotsMatrix, biasMatrix, projection);  
    //MultiplyMatrix(dotsMatrix, dotsMatrix, view); 
    //MultiplyMatrix(dotsMatrix, dotsMatrix, view_rotate);     
    MultiplyMatrix(dotsMatrix, dotsMatrix, modelWorld);  
 ...
 glUseProgram(baseRoom_SHADER);
          ...
          glUniformMatrix4fv(UNIFORM_DOTS_MATRIX_baseRoom,                      1, 0,    dotsMatrix);                      
          //---------------
          ...
          glUniform1i(UNIFORM_DOTS_TEXTURE,              2);
...
glBindTexture(GL_TEXTURE_2D, DOTS_TEXTUREMAP);                                                                                                                          
//---  
